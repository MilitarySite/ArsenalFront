...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../page/WeaponPage.html">Weapons</a></li>
    ...
    <section class="page-section py-0" id="diashow"> <!-- continua fu -->
        <div class="home-slider owl-carousel js-fullheight">
            ...
            <a href ="File2.php?id=2"  style="text-decoration: none;">
                <div class="slider-item js-fullheight" style="background-image:url(assets/img/slider-1.jpg);">
                    <div class="overlay"></div>
                <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
            ...
            <a href ="File2.php?id=3"  style="text-decoration: none;">
                <div class="slider-item js-fullheight" style="background-image:url(assets/img/slider-1.jpg);">
                    <div class="overlay"></div>
                <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
            ...
            <a href="File2.php?id=4"  style="text-decoration: none;">
                <div class="slider-item js-fullheight" style="background-image:url(assets/img/slider-1.jpg);">
                    <div class="overlay"></div>
                <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
            ...
            <a href="File2.php?id=5"  style="text-decoration: none;">
                <div class="slider-item js-fullheight" style="background-image:url(assets/img/slider-1.jpg);">
                    <div class="overlay"></div>
                <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
...
<script src="../js/animationguns.js"></script>
