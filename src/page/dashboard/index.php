                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>GitHub Source</h2>
												<p>Welcome to ArsenalFront <span class="bread-ntd">Admin interface</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-report">
											<button data-toggle="tooltip" data-placement="left" title="Go to" class="btn"><i class="icon nalika-chat"></i></button>
										</div>
                                    </div>
                                </div>
                            </div>
